...
function search1() {
    ...
    heading.innerHTML = "Carpenters";

    db.collection("Openings").where("category", "==", "Carpenters").get().then((res) => {
        res.forEach((doc) => {
            ...
            h14.innerHTML = 'Salary: ' + doc.data().price;
            hr.innerHTML = 'Phone: ' + doc.data().phone;
        });
    });
}
function search2() {
    ...
    cont.style.display = 'none';
    var heading = document.getElementById('heading');
    heading.innerHTML = "Electricians";

    db.collection("Openings").where("category", "==", "Electricians").get().then((res) => {
        res.forEach((doc) => {
            var ad = document.getElementById('ad');
            var row = document.createElement('div');
            var div1 = document.createElement('div');
...
function search3() {
    ...
    cont.style.display = 'none';
    var heading = document.getElementById('heading');
    heading.innerHTML = "Painter";

    db.collection("Openings").where("category", "==", "Painter").get().then((res) => {
        res.forEach((doc) => {
            var ad = document.getElementById('ad');
            var row = document.createElement('div');
            var div1 = document.createElement('div');
...
function search4() {
    ...
    cont.style.display = 'none';
    var heading = document.getElementById('heading');
    heading.innerHTML = "Plumber";
    db.collection("Openings").where("category","==", "Plumber").get().then((res) => {
            res.forEach((doc) => {
...
function search5() {
    ...
    cont.style.display = 'none';
    var heading = document.getElementById('heading');
    heading.innerHTML = "Welder";

    db.collection("Openings").where("category", "==", "Welder").get().then((res) => {
        res.forEach((doc) => {
            var ad = document.getElementById('ad');
            var row = document.createElement('div');
            var div1 = document.createElement('div');
    ...
    cont.style.display = 'none';
    var heading = document.getElementById('heading');
    heading.innerHTML = "Advanced Works";

    db.collection("Openings").where("category", "==", "Advanced Works").get().then((res) => {
        res.forEach((doc) => {
            var ad = document.getElementById('ad');
            var row = document.createElement('div');
            var div1 = document.createElement('div');
...
function search7() {
    ...
    db.collection("Openings").where("category", "==", "beauty").get().then((res) => {
        res.forEach((doc) => {
            var ad = document.getElementById('ad');
            var row = document.createElement('div');
            var div1 = document.createElement('div');
...
function search8() {
    ...
    db.collection("Openings").where("category", "==", "animals").get().then((res) => {
        res.forEach((doc) => {
            var ad = document.getElementById('ad');
            var row = document.createElement('div');
            var div1 = document.createElement('div');
...
function search9() {
    ...
    cont.style.display = 'none';
    var heading = document.getElementById('heading');
    heading.innerHTML = "All Availabilities";

    db.collection("Openings").get().then((res) => {
        res.forEach((doc) => {
            var ad = document.getElementById('ad');
            var row = document.createElement('div');
            var div1 = document.createElement('div');
...
function DisplayAdd(id){
   ...
   db.collection('Openings').doc(id).get().then(function(doc) {
...
function myAds() {
   ...
   cen.style.display = 'block';
    ...
    ads.innerHTML = "";
    db.collection('Openings').where('uid',"==",uid).get()
    .then((res) => {
        res.forEach((doc) => {
